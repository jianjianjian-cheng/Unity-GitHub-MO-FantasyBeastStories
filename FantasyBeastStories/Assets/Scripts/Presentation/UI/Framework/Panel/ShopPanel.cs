...
public class ShopPanel : UIScreen
{
    ...
    private void UpdateCoinDisplay()
    {
        if (coinText != null)
        {
            int coins = Application.CoinManager.Instance.GetCoins();
    ...
    private void OnRuneSelected(ShopRuneConfigSO runeConfig, RuneSlot runeSlot)
    {
        ...
        if (runeConfig.runeData != null)
        {
            ...
            var args = new Domain.Event.RuneEquipArgs(
                runeConfig.runeId,
    ...
    private void OnPurchaseClicked()
    {
        ...
        bool success = Application.ShopManager.Instance.PurchaseRune(selectedRune.runeId);
    ...
    private void UpdatePurchaseButtonState()
    {
        ...
        bool isAvailable = Application.ShopManager.Instance.IsRuneAvailable(selectedRune.runeId);
        bool hasPurchased = !selectedRune.allowRepeatPurchase && RuneInventory.HasRune(selectedRune.runeId);
        int currentCoins = Application.CoinManager.Instance.GetCoins();
