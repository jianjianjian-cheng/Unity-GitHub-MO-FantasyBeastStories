...
public class ShopPanel : UIScreen
{
  ...
  private void InitializeShop()
  {
    ...
    shopDatabase = AssetLoader.TryLoadAsset<ShopRuneDatabaseSO>("Lobby_Shop_ShopRuneDatabase");
    if (shopDatabase != null)
    {
  ...
  private void UpdateCoinDisplay()
  {
    if (coinText != null)
    {
      int coins = ServiceLocator.Get<CoinManager>().GetCoins();
  ...
  private void OnPurchaseClicked()
  {
    ...
    bool success = ServiceLocator.Get<ShopManager>().PurchaseRune(selectedRune.runeId);
  ...
  private void UpdatePurchaseButtonState()
  {
    ...
    bool isAvailable = ServiceLocator.Get<ShopManager>().IsRuneAvailable(selectedRune.runeId);
    bool hasPurchased = !selectedRune.allowRepeatPurchase && RuneInventory.HasRune(selectedRune.runeId);
    int currentCoins = ServiceLocator.Get<CoinManager>().GetCoins();
