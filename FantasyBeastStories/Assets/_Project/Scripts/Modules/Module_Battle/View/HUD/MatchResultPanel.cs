...
namespace Controllers.Battle
{
  public class MatchResultPanel : UIScreen
  {
      ...
      private void OnMatchStatsUpdated(MatchStatsUpdateData data)
      {
          ...
          {
              int currentCoins = ServiceLocator.Get<CoinManager>() != null
      ...
      private void OnCloseClicked()
      {
          ...
          if (ServiceLocator.Get<MatchStatisticsManager>() != null)
              ServiceLocator.Get<MatchStatisticsManager>().ConsumeMatchResult();
      ...
      protected override void OnBeforeClose()
      {
          ...
          if (ServiceLocator.Get<MatchStatisticsManager>() != null && ServiceLocator.Get<MatchStatisticsManager>().HasPendingMatchResult)
              ServiceLocator.Get<MatchStatisticsManager>().ConsumeMatchResult();
      }
