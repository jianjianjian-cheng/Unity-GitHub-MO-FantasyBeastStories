...
namespace UI.Framework.Widget
{
    ...
    {
        private const string CharactorPanelId = "CharacterPanel";
        private const string RunePanelId = "RunePanel";
        private const string MassionPanelId = "MissionPanel";
        ...
        {
            _selectedButtonImage = AssetLoader.LoadAsset<Sprite>("Lobby_UI_SelectedButton");
            _defaultButtonImage = AssetLoader.LoadAsset<Sprite>("Public_UI_DefaultButton");
        }
