...
namespace UI.RedDot
{
    ...
    public class RedDotView : UIWidget
    {
        ...
        protected override void SubscribeEvents()
        {
            ...
            // 注册时同步当前状态
            if (RedDotController.Instance != null && !string.IsNullOrEmpty(redDotKey))
                UpdateVisual(RedDotController.Instance.IsRedDotActive(redDotKey));
        }
        ...
        {
            RedDotController.Instance?.MarkAsRead(redDotKey);
        }
    }
}
