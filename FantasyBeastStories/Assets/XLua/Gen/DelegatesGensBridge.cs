...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp1(UnityEngine.Object p0, Core.SharedModel.SkillQueryData p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp2(UnityEngine.Object p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public bool __Gen_Delegate_Imp3(UnityEngine.Object p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public bool __Gen_Delegate_Imp4(UnityEngine.Object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp5(UnityEngine.Object p0, UnityEngine.Object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(Core.SharedModel.LuaVoidAction))
			{
			    return new Core.SharedModel.LuaVoidAction(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(Core.SharedModel.LuaSkillQueryAction))
			{
			    return new Core.SharedModel.LuaSkillQueryAction(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(Core.SharedModel.LuaElementAction))
			{
			    return new Core.SharedModel.LuaElementAction(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(Core.SharedModel.LuaSceneAction))
			{
			    return new Core.SharedModel.LuaSceneAction(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(Core.SharedModel.LuaBoolElementAction))
			{
			    return new Core.SharedModel.LuaBoolElementAction(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(Core.SharedModel.LuaBoolAction))
			{
			    return new Core.SharedModel.LuaBoolAction(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(Core.SharedModel.LuaAttackAction))
			{
			    return new Core.SharedModel.LuaAttackAction(__Gen_Delegate_Imp5);
			}
